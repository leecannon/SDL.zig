...
pub const AUDIO_S8 = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0x8008, .hex);
pub const AUDIO_U16LSB = @as(c_int, 0x0010);
pub const AUDIO_S16LSB = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0x8010, .hex);
pub const AUDIO_U16MSB = @as(c_int, 0x1010);
pub const AUDIO_S16MSB = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0x9010, .hex);
pub const AUDIO_U16 = AUDIO_U16LSB;
pub const AUDIO_S16 = AUDIO_S16LSB;
pub const AUDIO_S32LSB = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0x8020, .hex);
pub const AUDIO_S32MSB = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0x9020, .hex);
pub const AUDIO_S32 = AUDIO_S32LSB;
pub const AUDIO_F32LSB = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0x8120, .hex);
pub const AUDIO_F32MSB = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0x9120, .hex);
...
pub const SDL_WINDOWPOS_UNDEFINED_MASK = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_uint, 0x1FFF0000, .hex);
...
pub inline fn SDL_WINDOWPOS_ISUNDEFINED(X: anytype) @TypeOf((X & @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0xFFFF0000, .hex)) == SDL_WINDOWPOS_UNDEFINED_MASK) {
    return (X & @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0xFFFF0000, .hex)) == SDL_WINDOWPOS_UNDEFINED_MASK;
}
pub const SDL_WINDOWPOS_CENTERED_MASK = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_uint, 0x2FFF0000, .hex);
...
pub inline fn SDL_WINDOWPOS_ISCENTERED(X: anytype) @TypeOf((X & @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0xFFFF0000, .hex)) == SDL_WINDOWPOS_CENTERED_MASK) {
    return (X & @import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 0xFFFF0000, .hex)) == SDL_WINDOWPOS_CENTERED_MASK;
}
...
pub const SDL_JOYSTICK_AXIS_MIN = -@import("std").zig.c_translation.helpers.promoteIntLiteral(c_int, 32768, .decimal);
...
pub const SDL_HAPTIC_INFINITY = @import("std").zig.c_translation.helpers.promoteIntLiteral(c_uint, 4294967295, .decimal);
